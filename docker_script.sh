...
echo "****************************************************************"
docker run -d -p 7000:7000 --rm -v popcorn_popcorn_images:/app/images -v popcorn_popcorn_videos:/app/videos --network popcorn_network --name popocorn-api pratikgaikwad/$IMAGE:$BUILD_ID
